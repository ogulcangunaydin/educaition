...
def upgrade() -> None:
    ...
    if not table_exists('high_school_rooms'):
        op.create_table(
            'high_school_rooms',
    ...
    if not index_exists('ix_program_suggestion_students_id'):
