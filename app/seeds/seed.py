...
class UserSeeder(Seeder):
    SEED_USERS = {
        ...
        Environment.STAGING: [
            ...
            {
                "username": "staging_teacher",
                "email": "teacher@staging.example.com",
                "password": "StagingTeacher@123!",
                "role": "teacher",
                "is_active": True,
            },
            {
                "username": "staging_viewer",
                "email": "viewer@staging.example.com",
                "password": "StagingViewer@123!",
                "role": "viewer",
                "is_active": True,
            },
        ],
    ...
    def run(self):
        ...
        if not users_to_create:
            logger.info(
                f"No seed users defined for {settings.APP_ENV.value} environment"
            )
            return
