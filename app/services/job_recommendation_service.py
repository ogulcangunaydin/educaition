...
def get_job_recommendation(personality_scores: dict, gender: str, age: int) -> str:
    ...
    prompt = (
      f"Aşağıdaki bilgilere dayanarak maddelenmiş bir şekilde uygun 5 meslek önerisi yap. Her meslek önerisi için, ilgili kişilik özelliğinin sayısal değerine atıfta bulunarak sebep belirt. Ayrıca, meslek önerisinin kişinin yaşına ve cinsiyetine nasıl uygun olduğunu da açıkla:\n"
      f"Cinsiyet: {gender}\n"
      f"Yaş: {age}\n"
